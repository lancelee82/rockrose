...
class RRModelA3CConvPV(rr_model_base.RRModelBase):
    ...
    def model_init(self):
        ...
        ##pv_loss = self.a3c_pv_loss(self.policy_network, self.value_network, self.R_t, self.a_t)
    ...
    def a3c_pv_loss__1(self, p_network, v_network, R_t, a_t):
        ...
        def _inner_loss(y_true, y_pred, *args, **kwargs):
            ...
            v_loss = K.reduce_mean(K.square(R_t - v_network))
    ...
    def graph_init(self):
        ...
        File "/home/likun/mnt/b2/lk/proj/py/pyrl/rockrose/rockrose/trainers/a3c.py", line 167, in train_a_thread
